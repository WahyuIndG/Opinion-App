...
function BottomNavBar({ toggleDiscussModal }) {
  ...
  return (
    <nav className="w-full ">
      <ul className="w-full flex justify-evenly gap-2 p-1 bg-[rgba(16,16,16,0.8)] backdrop-blur-md">
        <Link
          to="/"
          className="hover:bg-[#1c1c1c] py-5 flex-grow flex justify-center items-center rounded-lg transition-all duration-150"
        >
          {active === '/' ? (
            <svg
